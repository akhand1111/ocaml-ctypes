...
(* OASIS_START *)
(* DO NOT EDIT (digest: 758651d1f0507a068ea9f95a5f98f1a6) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_struct_stubs",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_struct_stubs", []))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Struct_defs"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "stubtest";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "stubtest_run";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Generated_stubs"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "stubtest";
                      lib_findlib_name = Some "run";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "stubtests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "stubtest"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "generate_stubs.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_struct_stubs";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_struct_stubs.ml";
                      });
               Executable
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "9g\254\248\031\228\196.}Jv\028\170.\238\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
